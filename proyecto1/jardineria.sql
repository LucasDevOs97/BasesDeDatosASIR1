...
códigos de cliente que aparezcan repetidos. Resuelva la consulta:
...
SELECT DISTINCT codigo_cliente
FROM pago
WHERE DATE_FORMAT(fecha_pago, "%Y") = 2008; -- Tiene que indicarse en mayúsculas --
...
/*10. Devuelve un listado con el código de pedido, código de cliente, fecha esperada y fecha de entrega de los pedidos cuya fecha de entrega ha sido al menos 
dos días antes de la fecha esperada.
